<?php
    ...
    mysqli_set_charset($conn, 'utf8');
        ...
        $infor= mysqli_fetch_all($qrkhoa, MYSQLI_ASSOC);

    if (isset($_POST['edit_student']))
    {
        $data['MaSV'] = isset($_POST['MaSV']) ? $_POST['MaSV'] : '';
        $data['TenSV'] = isset($_POST['TenSV']) ? $_POST['TenSV'] : '';
        $data['MaKhoa'] = isset($_POST['MaKhoa']) ? $_POST['MaKhoa'] : '';
        ...
        if (!$errors){
           ...
           echo $sql = "INSERT INTO sinhvien(MaSV,TenSV,MaLop,MaKhoa, NgaySinh,
             QueQuan, GioiTinh, DanToc, TonGiao, SoCMT, NoiCapCMT, SDT, Email, DoiTuongMG)
             Values ('$msv','$ht',null,'$k','$ns','$qq','$gt','$dt','$tg','$cmt','$nccmt','$sdt','$em','$dtmg')";
                        ...
                        <div class="head_title">
                            ...
                            <div class="ttsv"
                                ...
                                <div>
                                    ...
                                    for($i=0;$i<$num;$i++){
                                    ?>
                                                    <option value="<?php echo "{$infor[$i]['MaKhoa']}" ?>">
                                                        <?php echo "{$infor[$i]['TenKhoa']}" ?></option>
                                                    <?php
                                    }
                                    ?>
                                                </select>
